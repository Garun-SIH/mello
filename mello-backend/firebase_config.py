...
def initialize_firebase():
    ...
    if credentials_path and os.path.exists(credentials_path):
        try:
            ...
            safe_print("Firebase Admin SDK initialized successfully with credentials file")
            return True
    ...
    try:
        ...
        firebase_admin.initialize_app(cred)
        safe_print("Firebase Admin SDK initialized successfully with environment variables")
        return True
    except Exception as e:
